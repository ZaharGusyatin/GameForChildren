...
class LevelSelectionFragment : Fragment(R.layout.fragment_level_selection) {
    override fun onResume() {
        super.onResume()
        button_level_selection_edible.setOnClickListener { replaceFragment(EdibleGameMainFragment()) }
        button_guess_by_the_sounds.setOnClickListener { replaceFragment(GuessByTheSoundFragment()) }
